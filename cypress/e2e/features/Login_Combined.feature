Feature: Login page
  ...
  Scenario Outline: Invalid <credential> entry on Amazon
    ...
    Then I should see an error message for invalid <type>

    Examples:
      | invalid_data        | credential | type         |
      | "invalidemail@"     | email      | email        |
      | "invalidemail.com"  | email      | email        |
      | "@invalidemail.com" | email      | email        |
      | "+31fgf6464w54"     | email      | email        |
      | "!@#$#%^&^*&*(())"  | email      | email        |
      | "45564646546456464" | mobile     | phone number |
      | "5464654"           | mobile     | phone number |
